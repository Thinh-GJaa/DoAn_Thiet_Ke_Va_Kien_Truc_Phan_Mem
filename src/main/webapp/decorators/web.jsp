...
<body>
	...
	<div class="main "
		style="background-color: #f5f5f5; background-image: url('https://images.unsplash.com/photo-1526289034009-0240ddb68ce3?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=1771&amp;q=80'); /* Thay 'url_hinh_anh.jpg' bằng đường dẫn đến hình ảnh của bạn */ background-size: cover; /* Kéo căng hình ảnh để phù hợp với kích thước màn hình */ background-repeat: no-repeat; /* Không lặp lại hình ảnh */ background-attachment: fixed;">
		<div class="grid ">
