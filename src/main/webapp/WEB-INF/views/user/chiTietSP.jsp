...
<script
	src="<c:url value='/templates/user/product/productDiscount.js'/>"></script>
<script
	src="<c:url value='/templates/user/product/productCategory.js'/>"></script>
...
<body>
	<div class="container-fluid ">
						...
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item">
								...
								<c:choose>
									...
									<c:otherwise>
										<del><span data-gia="${gia }" id="giaBan"></span></del> <span
								data-giaKM="${giaKM}" id="giaKM"></span>
									</c:otherwise>
								</c:choose>
							</li>
		...
		<div class="row khung">
			...
			<section class="container my-5">
				 <h2 class="text-center mt-5 mb-5" style="color: #9ca0a2">----Các sản phẩm tương tự----</h2>
				<div class="row">
									...
									<a href="/user/chi-tiet-sp/${i.mathang.mamh}">
										<div style="position: relative;">
											...
											<span
												...
												id="priceSpan" class="priceSpan"> ${i.giamoi}</span>
											<!-- Ảnh sản phẩm -->
	...
	<!-- định dạng tiền tệ -->
	<script>
	// Lấy tất cả các phần tử có class 'priceSpan'
