...
.fixed-buttons {
	...
	right: 0;
	left: 0;
	background-color: #fff; /* Màu nền của phần cố định */
	padding: 10px; /* Khoảng cách đệm */
	box-shadow: 0px -5px 5px rgba(0, 0, 0, 0.1); /* Đổ bóng ở dưới */
	z-index: 999; /* Lớp hiển thị trên cùng */
}
...
<body>
	...
	<!--CHương trình chính  -->
	<div class="container" style="font-size: 16px;color: #FFFFFF; ">
		<div class="row">

			<div class="col col-md-11 mt-4">
				<h3 class="my-4">
					<a href="#"
				...
				<table class="table" style="font-size: 16px;color: #FFFFFF; ">
					<thead>
						<tr>
							<th scope="col"><input type="checkbox"
								id="select-all-checkbox"> Chọn tất cả</th>
						...
						<c:forEach var="crt" items="${GioHang}">
							<tr>
								<td><input type="checkbox"
									id="select-checkbox-${crt.idProduct}" class="select-checkbox"
									name="selectedProducts" value="${crt.idProduct}"
									data-size="${crt.getSize()}"></td>
								<td style="width: 200px;"><span class="product-name">${crt.setTenMHString()}</span>
								</td>
								<td class="size">${crt.getSize()}</td>
								<td style="width: 110px;">
									<div class="input-group">
										<input type="number" class="form-control quantity-input"
											min="1" max="${crt.Max_Quantity()}"
				...
				<input type="hidden" id="idProductToDelete" name="idProductToDelete"
					value=""> <input type="hidden" id="sizeToDelete"
					name="sizeToDelete" value="">
				 <div class="fixed-buttons">
            <div class="text-right">
                <a href="/user/index" type="button" class="btn btn-lg btn-primary">Tiếp tục mua hàng</a>
                <button id="btnThanhToan" class="btn btn-lg btn-success">Thanh toán</button>
            </div>
