...
<body>
	...
	<div class="container-fluid" style="margin: 20px">
		<form id="paymentForm" action="/user/thanhToan" method="post">
			<div class="row khung">
								...
								<div class="product-info">
									...
									<div class="product-row product-name">
										<h2 class="mt-2" style="text-align: center;">
											<a
												href="/user/chi-tiet-sp/${sp.getCtSize().getMathang().getMamh()}">${loop.index +1}.
									...
									<div class="product-row product-details product-quantity">
										<p class="card-text product-details product-quantity">
											<strong>Đơn giá: </strong><span id="donGia"
												data-donGia="${sp.getDonGiaKM()}"></span>
										</p>
										<p class="card-text product-details product-quantity">
									...
									<div class="product-row product-quantity">
										<p class="card-text product-quantity" style="font-size: 18px;">
											<strong>Thành tiền:</strong> <span id="thanhTien"
												data-thanhTien="${sp.donGiaKM*sp.soLuong}"
				...
				<div class="col-md-4 mt-4">
					<label class="head_"><strong>Người nhận & thanh
							toán</strong></label>
					<div class="fixed-payment">
						...
						<div class="form-group">
							<label for="province">Tỉnh/Thành phố</label> <input type="text"
						...
						<div class="form-group">
							<label for="ward">Phường/Xã</label> <input type="text"
								name="ward" id="ward" class="form-control"
						...
						<div class="form-group tongTien">
							<label for="tongTien">Tổng tiền: </label> <span class=""
								id="tongTien" data-tongTien="${tongTienKM}"></span> <input
								type="hidden" name="tongTienKM" value="${tongTienKM}">
						</div>
...
thanhTienElement.forEach((e) => {
	...
	<script type="text/javascript">
        ...
        document.querySelector("#paymentForm").addEventListener("submit", function(event) {
            ...
            // Hiển thị thông báo và chờ 2 giây trước khi gửi form
            Swal.fire({
                icon: 'success',
                ...
                // Sau khi thông báo kết thúc, gửi form
