						...
						<div class="card">
							<div class="card-body">
								<div class="table-container">
									<h1 class="table-title text-center">Phiếu Nhập Hàng</h1>
									...
									<div class="fixed-buttons mt-3">
										<!-- Nút để mở dialog -->
										<button type="button" id="openModalBtn" class="btn btn-primary">Thêm Sản Phẩm</button>

										<!-- Nút để mở dialog -->
										<button type="button" id="btnThemPN" class="btn btn-success">Thêm phiếu nhập</button>
									</div>

									<!-- Modal thêm chi tiết sản phẩm vào phiếu nhập -->
									<div class="modal fade" id="productModal" tabindex="-1" role="dialog" aria-labelledby="productDialogLabel" aria-hidden="true">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														...
														<div class="d-flex">
															<select id="productName" name="productName" class="form-control selectpicker" data-live-search="true" required>
																<c:forEach var="sp" items="${dsMatHang}">
																	<option value="${sp.getMamh()}">Mã SP: ${sp.getMamh()} _ ${sp.getTenmh()}</option>
																</c:forEach>
															</select>
															<span class="ml-2">
													...
													<div class="form-group">
														...
														<div class="d-flex">
															<select id="productSize" name="productSize" class="form-control" required>
																<c:forEach var="size" items="${dsSize}">
																	<option value="${size.getMasize()}">${size.getTensize()}</option>
																</c:forEach>
															</select>
															<span class="ml-2">
																<button type="button" class="btn btn-primary" id="openAddSizeModal">
																	<i class="fa fa-plus-square"></i>
																</button>
															</span>
														</div>
													...
													<div class="form-group">
														<label for="productGiaNhap">Giá Nhập:</label>
														<input type="number" class="form-control" id="productGiaNhap" name="productGiaNhap" required min="1" value="" />
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-success" id="addProductBtn">Thêm Vào Phiếu</button>
										...
										<div class="modal-dialog" role="dialog">
											<div class="modal-content">
												...
												<form action="/admin/them-sp-moi" method="post" id="formThemSPMoi">
													<div class="modal-body">
														<div class="form-group">
															<label for="tenSPMoi">Tên Sản phẩm mới: </label>
															<input type="text" class="form-control" id="tenSPMoi" name="tenSPMoi" required />
														</div>
														<div class="form-group">
															<label for="loaiSP">Loại Sản phẩm:</label>
															<select id="loaiSP" name="loaiSP" class="form-control" required>
														...
														<div class="form-group">
															...
															<select id="nhanHieu" name="nhanHieu" class="form-control" required>
														...
														<div class="form-group">
															<label for="cachLam">Cách làm: </label>
															<select id="cachLam" name="cachLam" class="form-control" required>
														...
														<div class="form-group">
															<label for="themAnh">Hình ảnh: </label>
															<input type="file" class="form-control" id="themAnh" name="themAnh" required multiple accept=".jpg, .png" />
														</div>
													</div>
													<div class="modal-footer">
										...
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												...
												<form action="" id="formThemSizeMoi">
													<div class="modal-body">
														<div class="form-group">
															<label for="sizeMoi">Tên size mới: </label>
															<input type="text" class="form-control" id="sizeMoi" name="sizeMoi" required />
														</div>
													</div>
													<div class="modal-footer">
									...
									<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.3/dist/umd/popper.min.js" type="text/javascript"></script>
									<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" type="text/javascript"></script>
									<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
									<script src="<c:url value='/templates/admin/js/nhapHang.js'/>" type="text/javascript"></script>
