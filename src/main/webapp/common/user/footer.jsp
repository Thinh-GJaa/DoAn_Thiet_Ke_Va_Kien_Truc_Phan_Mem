        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-center">
                <div class="">
                    ...
                    <p>Địa chỉ: 97 Man Thiện, Hiệp Phú, TP.Thủ Đức</p>
                    <p>Email: doanThietKe&KienTrucPhanMem@gmail.com</p>
                    <p>Điện thoại: 0123 456 789</p>
                </div>
            </div>
             <div class="col-md-4 d-flex justify-content-end">
              <div class="align-self-center" >
                <h3>Tác giả</h3><div class="small"> Thịnh - Triệu - Đại</div>
                <p>Được thực hiện bởi Nhóm ABC vào tháng 6 năm 2024.</p>
