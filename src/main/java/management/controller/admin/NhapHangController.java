...
//	        tmp.setCtsize(ctsize);
	...
	public ResponseEntity<String> themAnhMoi(@RequestParam("mamh") int mamh, @RequestParam("url") String url,
		...
		String url_fb = "https://firebasestorage.googleapis.com/v0/b/web-ban-hang-thoi-trang.appspot.com/o/images%2Fproducts%2F";
	...
	{	
		model.addAttribute("receiptDao", nhapHangDao);
		List<Phieunhap> receipts = nhapHangDao.getListReceipt();
